...
const ShippingRatesPage = () => {
  ...
  return (
    ...
    <div className="min-h-screen text-black bg-black py-8 px-4 sm:px-6 lg:px-8">
        ...
        {trackingObj && (
          <div className="mt-8">
            ...
            <Link href={`/tracking/?labelId=${trackingObj.labelId}`}>
              <button className="px-4 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-600">Track Order</button>
            </Link>
          </div>
        )}
        {errors.length > 0 && (
